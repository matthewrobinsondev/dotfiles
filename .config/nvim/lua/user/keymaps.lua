...
vim.keymap.set('n', '<leader>oy', ':Obsidian yesterday<CR>', { desc = '[O]bsidian [Y]esterday' })
vim.keymap.set('n', '<leader>on', ':Obsidian new<CR>', { desc = '[O]bsidian [N]ew' })
vim.keymap.set('n', '<leader>of', ':Obsidian new_from_template<CR>', { desc = '[O]bsidian [F]rom Template' })
vim.keymap.set('n', '<leader>sot', ':Obsidian tags<CR>', { desc = '[S]earch [O]bsidian [T]ags' })
vim.keymap.set('n', '<leader>sod', ':Obsidian dailies<CR>', { desc = '[S]earch [O]bsidian [D]ailies' })
